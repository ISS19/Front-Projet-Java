...
const NavbarSecteur = () => {
    ...
    const changeMdp = (e) => {
        e.preventDefault();
        const mdpChange = { "ancienMdp": ancienMdp, "nouveauMdp": mdp };
    ...
    return (
        <div className={style.navbar}>
            ...
            <br /><br />
            <Link href={"/Chat/chat"} className={style.Link}>
                <div className={style.navBouton}>
                    <img src="/assets/img/message.png" alt="" className={style.navimg} />
                    <h4 className={style.textOverlay}>Message</h4>
                </div>
            </Link>
            <br /><br />
